...
function ImagesMobile() {
  ...
  return (
    <group ref={group}>
      <Image position={[0.5, 1.5, 0]} scale={[5, 3, 1]} url={images9} />
      <Image position={[0.5, -1.5, 1]} scale={2} url={images12} />
      <Image position={[-0.8, -6.5, 2]} scale={[1, 3, 1]} url={images10} />
      <Image position={[0.4, -6.5, 3]} scale={[1, 2, 1]} url={images10} />
      <Image position={[0.6, -6.5, 4]} scale={0.5} url={images10} />
